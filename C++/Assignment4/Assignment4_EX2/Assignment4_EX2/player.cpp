...
void player::transfer(player &p)
{
	...
	system("pause");
	bag.set(bag.nOfHeal()+p.bag.nOfHeal(),bag.nOfMW()+p.bag.nOfMW());//Blank 3:get the Heal and Magic water from died enemy
...
// display character's job
void showinfo(player &p1, player &p2) //Blank 4: friend function to class player
{
	system("cls");
	cout<<"##############################################################"<<endl;
